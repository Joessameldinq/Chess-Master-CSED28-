...
//Check if piece can move to pos only geometrically we use it in the functino isSquareAttacked which is used to determine check
...
bool isValidMove(Game *game, Move move)
{
    ...
    // Only geometric check and ignore king in check rule
